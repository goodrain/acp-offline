...
baseurl=http://repo.goodrain.com/centos/\$releasever/2017.03/\$basearch
enabled=1
gpgcheck=1
...
baseurl=http://repo.goodrain.com/centos/\$releasever/2017.03/noarch
enabled=1
gpgcheck=1
gpgkey=http://repo.goodrain.com/gpg/RPM-GPG-KEY-CentOS-goodrain
EOF
...
echo "DC_AGENT_OPTS='-s http://$LOCAL_IP:4001 --ip $LOCAL_IP'" > /etc/goodrain/envs/dc-agent.sh
